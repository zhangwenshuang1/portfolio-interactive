...
export default function DocumentaryCarouselPanel({ puzzle, onClose }: PanelProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 flex flex-col overflow-y-auto bg-[#070a10]"
    >
      <motion.div
      ...
      >
        <div className="mb-2 flex items-center justify-between">
          <div>
            ...
            <h1
              className="mt-1 text-3xl font-black text-white drop-shadow-[0_4px_18px_rgba(125,211,252,0.35)] sm:text-4xl"
              style={{ fontFamily: "'ZCOOL KuaiLe','Microsoft YaHei',sans-serif" }}
            >
              纪录片实习《寻找未来的人》 · 项目统筹
            </h1>
            <p className="mt-1 max-w-[560px] text-[12.5px] font-medium text-[#c6d3e2]/70 sm:text-sm">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-4 py-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 pb-1 text-center text-[10.5px] font-semibold uppercase tracking-[0.28em] text-[#8ea3b8]/70">
