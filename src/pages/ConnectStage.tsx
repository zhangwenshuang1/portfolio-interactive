...
const T = {
  // 1 · 第一次小组作业，全英文短片
  t1:
    '第一次小组作业，我们决定拍一条全英文的片子。\n' +
    '那也是我第一次真正把一个模糊的想法，一步一步变成眼前的画面。从剧本、分镜，到道具准备，再到现场拍摄，我第一次完整地走过了一遍从创意到落地的过程。\n' +
  ...
  // 4 · 第一次站上讲台，读现代诗
  t5:
    '第一次站上讲台，面对的是一群比我想象中更有想象力的孩子。\n' +
    '那天，我们一起读现代诗。没有标准答案，也没有一定要写成什么样子的句子。我只是试着带他们去看看诗里的世界，也鼓励他们写下自己真正想说的话。\n' +
    '没想到，最后让我惊喜的，是他们写出来的那些诗。\n' +
    '有些句子很稚拙，却有一种成年人很难再拥有的真诚。那些关于风、云、家乡和夏天的想象，被他们写在纸上，简单，却漂亮得让人记了很久。\n' +
    '我原本以为，那一天我是站在讲台上，把一些东西教给他们。\n' +
    '后来才发现，有时候人与人的连接并不是单向的。我们把一点点知识和鼓励递给彼此，也在彼此身上发现新的东西。\n' +
    '那天之后，我开始相信，每个人心里其实都藏着一首还没有写完的诗。',

  // 5 · 家访
  t6:
    '离开教室，我们走进了孩子们真正生活的地方。\n' +
    '家访的路比想象中更长，也是在这一路上，我第一次开始把课堂里的他们，和生活里的他们慢慢联系起来。我们和家人聊天，看看他们每天生活的环境，也听他们讲起孩子平时的学习和成长。\n' +
    '有些细节其实很安静，却让我记了很久。\n' +
    '原来一个孩子在课堂上的沉默、兴奋，甚至偶尔的一点调皮，背后都有着属于自己的生活。那天以后，我再看他们的时候，好像也多了一层理解。\n' +
    '我开始意识到，真正认识一个人，从来不只是知道他的名字，听他说过什么，而是愿意走近一点，看看他从哪里来，又是怎样一点一点长成现在的模样。\n' +
    '从教室到家里，距离并不远，却让我更靠近了他们。',

  // 6 · 第一次班会，聊未来
  t7:
    '第一次班会，我们一起玩游戏，也坐下来聊了很多。\n' +
    '聊喜欢什么，聊以后想做什么，也聊起他们眼里的未来。那些还没有完全成形的梦想，被他们很认真地说出来，有些天真，却也格外真实。\n' +
    '那时候我一直在想，我究竟希望他们以后变成什么样的人？\n' +
    '好像并不是一定要考到很远的地方，也不是一定要去大城市，拥有一份看起来很「成功」的人生。\n' +
    '我只是希望，他们有一天能够凭自己的努力，走出去看看。\n' +
    '去看看更大的世界，遇见不同的人，知道生活原来有很多种可能。然后有一天，当他们真正见过一些风景之后，依然可以按照自己的意愿，选择想要怎样生活。\n' +
    '因为我觉得，所谓「走得更远」，从来不只是走了多少公里。\n' +
    '而是当你看见过更多可能之后，依然有能力选择自己想要的人生。',

  // 7 · 支教伙伴，革命友谊
  t8:
    '支教的日子里，我们白天一起上课，一起吃饭，也一起为各种琐碎的事情忙碌。\n' +
    '到了晚上，大家又挤在一起熬夜看乒乓球比赛。白天的疲惫好像都被暂时忘掉了，一场比赛、一阵欢呼，就能让所有人重新热闹起来。\n' +
    '我们一起经历了很多平凡的小事，也一起度过了一段并不算长，却足够特别的日子。\n' +
    '大概就是在这样的相处里，人与人之间慢慢有了另一种连接。没有刻意去建立关系，只是一起做事、一起吃饭、一起熬夜，久而久之，就有了一种很难被替代的「革命友谊」。\n' +
    '支教结束之后，我们各自回到原来的生活，去了不同的地方，忙着不同的事情。\n' +
    '可我一直觉得，那段时间遇见的人，是我大学里最珍贵的朋友之一。\n' +
    '有些人只陪你走过一小段路，却会成为青春里很长久的记忆。',

  // 8 · 操场踢足球
  t9:
    '支教的时候，我也会和孩子们一起跑到操场上踢足球。\n' +
    '没有什么特别的规则，也没有人在意谁踢得好不好。一个球，一片操场，追着跑、摔倒了再爬起来，进了球就开心地欢呼。\n' +
    '那一刻，我突然觉得，他们的快乐真的很简单。\n' +
    '其实我也没有比他们大多少，可站在他们中间，我却有一点羡慕。羡慕他们还可以因为一个进球开心很久，可以毫无顾虑地奔跑、大笑，把所有情绪都写在脸上。\n' +
    '长大好像并不是一夜之间发生的。只是我们慢慢开始在意结果，在意别人怎么看，也渐渐学会把很多情绪藏起来。\n' +
    '而那天下午的操场上，他们还是最纯粹的自己。\n' +
    '我也希望自己能够一直保留一点这样的能力，认真地去喜欢一件小事，也认真地享受当下的快乐。',

  // 9 · 最后的全班合照
  t10:
    '这是我们最后的全班合照。\n' +
    '从第一天开始，我就努力记住每一个人的名字。下课的时候一个个对着名字叫，生怕叫错，也怕还没真正认识他们，就已经要离开。\n' +
    '可到了现在，我不得不承认，我已经忘记了很多人的名字。\n' +
    '有些名字甚至已经想不起完整的样子。\n' +
    '但很奇怪，我依然记得他们笑起来的样子。记得他们在操场上奔跑时的身影，记得课堂上举起手的瞬间，也记得他们看着我时那种毫无防备的眼神。\n' +
    '也许记忆本来就是这样。名字会被时间慢慢带走，但那些真正触动过你的瞬间，会留下来。\n' +
    '所以现在回头看，与其说那段时间是我们去陪伴他们、去教他们一些东西，不如说，是他们也用自己的真诚和纯真，治愈了那个奔波在生活里的我。\n' +
    '我们以为自己是去给予一些什么。\n' +
    '最后却带着更多东西离开了。',
  ...
  t11:
    ...
    '那是一段很慢的旅程。车厢会随着铁轨轻轻晃动，窗外的风景一点一点向后退，而我们就在这趟漫长的旅途中，一起备课、聊天、唱歌，也讨论着即将面对的孩子和还没有发生的故事。\n' +
    '现在回想起来，我很喜欢那 48 个小时。\n' +
    '因为那时的我们，好像都还带着一种很鲜明的年轻感。对即将到来的生活充满期待，也愿意为了一件自己相信的事情，坐上两天两夜的火车，去一个很远的地方。\n' +
    '车厢里没有什么宏大的理想宣言。\n' +
    '只是有人低头改着教案，有人分享着耳机里的歌，有人聊起未来想做的事情。大家坐在一起，疲惫却兴奋，眼睛里都有一点对未知的期待。\n' +
    '也许青春最珍贵的地方，就在于我们还愿意因为相信一件事，就一起出发。\n' +
    '那趟绿皮火车很慢。\n' +
    '但载着一群年轻人，向着很远的地方，也向着各自还没有抵达的未来。',

  // 11 · 站在讲台上的日子
  t12:
    '站在讲台上的那段时间，可能是我大学四年里最无忧的一段日子。\n' +
    '云南的天气很好，风吹过来总是很轻。课间的时候抬头看看远处的山和天空，会突然忘记自己原本还在南京，被课程、论文和实习填满的生活。\n' +
    '我只是带着一颗很简单的心来到这里。\n' +
    '没有想过一定要留下些什么，也没有想过自己能够改变什么。只是认真地备课，认真地和孩子们相处，在一堂又一堂课里，慢慢认识他们，也慢慢认识那个暂时不用考虑那么多事情的自己。\n' +
    '那段时间，我好像暂时从原来的生活里走了出来。\n' +
    '每天有孩子们的笑声，有阳光，有风，有一群志同道合的人，也有一种很久没有感受到的轻松。\n' +
    '然后我才发现，原来真正治愈我的，不只是云南的风景。\n' +
    '是我重新拥有了一段时间，可以什么都不急着证明，只是认真地生活。\n' +
...
const PAGES: Page[] = [
  ...
  { key: 'p02', photo: '02', index: '02', titleEn: 'TO REMEMBER', placeEn: 'NANJING', placeCn: '南京', date: '2023.12', story: T.t2 },
  { key: 'p03', photo: '03', index: '03', titleEn: 'TO REMEMBER · II', placeEn: 'NANJING', placeCn: '南京', date: '2023.12', story: T.t3 },
  { key: 'p04', photo: '04', index: '04', titleEn: '48 HOURS', placeEn: 'ON THE ROAD', placeCn: '路上', date: '2024.07', story: T.t11 },
  { key: 'p05', photo: '05', index: '05', titleEn: 'A POEM IN SUMMER', placeEn: 'YUNNAN', placeCn: '云南 · 妥甸中学', date: '2024.07', story: T.t5 },
  { key: 'p06', photo: '06', index: '06', titleEn: 'BEYOND THE CLASSROOM', placeEn: 'YUNNAN', placeCn: '云南 · 妥甸中学', date: '2024.07', story: T.t6 },
  { key: 'p07', photo: '07', index: '07', titleEn: 'SEE THE WORLD', placeEn: 'YUNNAN', placeCn: '云南 · 妥甸中学', date: '2024.07', story: T.t7 },
  { key: 'p08', photo: '08', index: '08', titleEn: 'THE PEOPLE I MET', placeEn: 'YUNNAN', placeCn: '云南 · 妥甸中学', date: '2024.07', story: T.t8 },
  { key: 'p09', photo: '09', index: '09', titleEn: 'THE JOY OF PLAY', placeEn: 'YUNNAN', placeCn: '云南 · 妥甸中学', date: '2024.07', story: T.t9 },
  { key: 'p10', photo: '10', index: '10', titleEn: 'A LITTLE WHILE', placeEn: 'YUNNAN', placeCn: '云南 · 妥甸中学', date: '2024.07', story: T.t10 },
  { key: 'p11', photo: '11', index: '11', titleEn: 'ON THE PODIUM', placeEn: 'YUNNAN', placeCn: '云南 · 妥甸中学', date: '2024.07', story: T.t12 },
]
            ...
            <div className="relative flex min-h-0 flex-1 flex-col pl-3">
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p
                    className="mt-1.5 text-[15px] text-[#7a6647]"
                  ...
                  {page.date && (
                    <p
                      className="mt-0.5 text-[13px] text-[#9c8358]"
                      style={{ fontFamily: "'Ma Shan Zheng','Kaiti SC',KaiTi,serif" }}
                    >
                      {page.date}
                    </p>
