...
const T = {
  ...
  t1:
    ...
    '那也是我第一次把一个模糊的想法，一步一步变成眼前的画面：写剧本、画分镜、准备道具，再到现场拍摄。\n' +
    '那时的自己还有很多不成熟的地方，但正是在一次次讨论、修改和临场应变里，我第一次真切地感受到：一个想法被实现的过程，本身就很有趣。\n' +
    '也是从那时候开始，我越来越确定，自己想做的事情，是把脑海里的故事变成真实的画面。',

  // 2 · 侵华日军遇难同胞纪念馆 · 志愿（上）
  t2:
    '在纪念馆做志愿的那天，我们站在入口附近，和一位又一位前来参观的人聊起他们对这段历史的印象。\n' +
    '原本以为自己是在记录别人的答案，真正开始交流之后，才发现每一个回答背后，都藏着不同的记忆与情绪。',

  // 3 · 侵华日军遇难同胞纪念馆 · 志愿（下）
  t3:
    '那些被反复提起的名字与故事，不再只是课本里的文字。站在这里，听人们谈起这段历史，我才第一次具体地感受到，所谓「记住」，是一个个真实的人，在时间里留下的痕迹。\n' +
    '有些记忆之所以需要被留下，是因为总有人愿意认真地听见，并把它继续传下去。',

  // 4 · 第一次站上讲台，读现代诗
  t5:
    '第一次站上讲台，面对的是一群比我想象中更有想象力的孩子。那天，我们一起读现代诗，没有标准答案，也没有规定要写成什么样子。\n' +
    '最后让我惊喜的，是他们写出来的诗。有些句子很稚拙，却有一种成年人很难再拥有的真诚。\n' +
    '我原本以为，那天是我站在讲台上教给他们一些东西。后来才发现，连接并不是单向的，我们把一点点知识递给彼此，也在彼此身上发现新的东西。\n' +
    '那天之后，我开始相信，每个人心里都藏着一首还没有写完的诗。',

  // 5 · 家访
  t6:
    '离开教室，我们走进了孩子们真正生活的地方。家访的路比想象中更长，我们和家人聊天，看看他们每天生活的环境，也听他们讲起孩子的成长。\n' +
    '有些细节很安静，却让我记了很久。原来一个孩子在课堂上的沉默、兴奋，背后都有着属于自己的生活。\n' +
    '我开始意识到，真正认识一个人，不只是知道他的名字，而是愿意走近一点，看看他从哪里来，又是怎样长成现在的模样。\n' +
  ...
  t9:
    ...
    '那一刻我忽然觉得，他们的快乐真的很简单。\n' +
    '其实我也没有比他们大多少，可站在他们中间，我却有一点羡慕——羡慕他们可以因为一个进球开心很久，可以毫无顾虑地奔跑、大笑，把情绪都写在脸上。\n' +
    '长大好像并不是一夜之间发生的，只是我们慢慢开始在意结果，也渐渐学会把情绪藏起来。\n' +
    '我也希望自己能一直保留一点这样的能力，认真地喜欢一件小事，也认真地享受当下的快乐。',

  // 9 · 最后的全班合照
  t10:
    '这是我们最后的全班合照。\n' +
    '从第一天起，我就努力记住每一个人的名字，害怕还没真正认识他们，就已经要离开。\n' +
    '可到了现在，我不得不承认，我已经忘记了很多人的名字。\n' +
    '但很奇怪，我依然记得他们笑起来的样子，记得他们在操场上奔跑的身影，也记得他们看着我时那种毫无防备的眼神。\n' +
    '也许记忆本来就是这样：名字会被时间慢慢带走，但那些真正触动过你的瞬间，会留下来。\n' +
    '与其说那段时间是我们去陪伴他们，不如说，是他们用自己的真诚和纯真，治愈了那个奔波在生活里的我。\n' +
    '我们以为自己是去给予一些什么，最后却带着更多东西离开了。',

  // 10 · 48 小时绿皮火车
  t11:
    '从南京到云南，我们坐了整整 48 个小时的绿皮火车。\n' +
    '车厢随着铁轨轻轻晃动，窗外的风景一点一点向后退，我们就这样在漫长的旅途中备课、聊天、唱歌。\n' +
    '那时的我们都带着很鲜明的年轻感，愿意为了一件自己相信的事，坐上两天两夜，去一个很远的地方。\n' +
    '有人低头改着教案，有人分享着耳机里的歌，疲惫却兴奋，眼睛里都藏着对未知的期待。\n' +
    '那趟火车很慢，却载着一群年轻人，向着很远、也向着各自还没有抵达的未来。',

  // 11 · 站在讲台上的日子
  t12:
    '站在讲台上的那段时间，可能是我大学四年里最无忧的一段日子。\n' +
    '云南的天气很好，风吹过来总是很轻。课间抬头看看远处的山和天空，会突然忘记自己原本还在南京，被课程、论文和实习填满的生活。\n' +
    '我只是带着一颗很简单的心来到这里，没想过要留下什么，也没想过能改变什么。只是认真地备课，认真地和孩子们相处，在一堂又一堂课里，慢慢认识他们，也慢慢认识那个暂时不用考虑那么多的自己。\n' +
    '每天有孩子们的笑声，有阳光，有风，有一群志同道合的人，也有一种很久没有感受到的轻松。\n' +
    '然后我才发现，真正治愈我的，不只是云南的风景，而是我重新拥有了一段时间，可以什么都不急着证明，只是认真地生活。\n' +
    '最后我还是会回到南京，回到那些需要继续面对的事情里。但至少那一次，我是带着孩子们给我的快乐回去的。',
}
            ...
            <div className="relative flex min-h-0 flex-1 flex-col pl-3">
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p
                    className="mt-1.5 text-[17px] text-[#7a6647] sm:text-[18px]"
                  ...
                  {page.date && (
                    <p
                      className="mt-0.5 text-[15px] text-[#9c8358] sm:text-[16px]"
                      style={{ fontFamily: "'Ma Shan Zheng','Kaiti SC',KaiTi,serif" }}
                    >
                      {page.date}
                    </p>
              ...
              <div className="relative mt-4 min-h-0 flex-1 overflow-y-auto pr-1">
                <p
                  className="whitespace-pre-line text-[18px] leading-[2.15] text-[#4a3a28] sm:text-[20px] lg:text-[21px]"
                  style={{ fontFamily: "'Ma Shan Zheng','Kaiti SC',KaiTi,serif" }}
                >
                  {page.story}
                </p>
