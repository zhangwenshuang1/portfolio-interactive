 ...
 * 因此调整 photo 的顺序即可把某张照片移动到指定页，而不必重命名图片文件。
 */
const PAGES: Page[] = [
  {
    key: '01',
    ...
    story:
      ...
      '时间是 2023 年 9 月 14 日，天气晴，地点在南京大学鼓楼校区。',
  },
  {
    key: '02',
    photo: '09',
    ...
    story:
      ...
      '时间是 2024 年 12 月 13 日，国家公祭日，地点在侵华日军南京大屠杀遇难同胞纪念馆。',
  },
  {
    key: '03',
    photo: '08',
    index: '03',
    titleEn: 'A POEM IN SUMMER',
    placeEn: 'YUNNAN',
    placeCn: '云南 · 妥甸中学',
    date: '2024.07.23',
    story:
...
// 确保始终有 11 页（避免 history 调整导致页数不符）
            ...
            <div className="relative flex min-h-0 flex-1 flex-col pl-3">
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="font-cartoon-latin mt-1 text-[10px] font-bold uppercase tracking-[0.26em] text-[#bda578]">
                    {page.placeEn}
                  </p>
                </div>
